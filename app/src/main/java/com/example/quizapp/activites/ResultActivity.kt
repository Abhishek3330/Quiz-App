...
class ResultActivity : AppCompatActivity() {
    ...
    private lateinit var tryMoreQuiz :Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tryMoreQuiz = findViewById(R.id.tryMoreQuiz)

        setUpViews()

        tryMoreQuiz.setOnClickListener {
    ...
    private fun setAnswerView() {
        ...
        for (entry in quiz.questions.entries){
            val question = entry.value
            builder.append("<font color'#18206F'><b>Question: ${question.description}</b></font><br/>")
